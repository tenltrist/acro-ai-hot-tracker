    ...
    def test_retention_and_allowlist(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            first = {"generated_at": "2026-09-08T00:00:00", "items": [
                {"id": "a", "title": "Original", "summary_method": "rule", "ai_summary": "Invented action", "internal_acro": 1},
                {"id": "b", "title": "Keep me", "summary_method": "manual_ai", "ai_summary": "Reviewed summary"},
            ]}
            ...
            second = {"generated_at": "2026-09-09T00:00:00", "items": [{"id": "a", "title": "Updated"}]}
