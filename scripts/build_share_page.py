...
def main() -> int:
    ...
    html = html.replace('    <link rel="stylesheet" href="./styles.css?v=20260716h" />', f"    <style>\n{css}\n    </style>")
    html = html.replace('    <script src="./embedded-data.js?v=20260716h"></script>', f"    <script>\n{embedded}    </script>")
    html = html.replace('    <script src="./app.js?v=20260716h"></script>', f"    <script>\n{js}\n    </script>")
